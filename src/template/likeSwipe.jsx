...
// Removed: Ant from 'react-native-vector-icons/AntDesign';
// Removed: Shares from 'react-native-vector-icons/Entypo';
// Removed: Like from 'react-native-vector-icons/Foundation';
import Share from 'react-native-share'; // Import the share module
// Removed: Phone from 'react-native-vector-icons/FontAwesome6';
// Removed: Score from 'react-native-vector-icons/MaterialCommunityIcons';
// Removed: Whatsapp from 'react-native-vector-icons/Entypo';
...
const BACK_ICON = ' \u2B05\uFE0F'; // Leftwards black arrow in a circle
const SHARE_ICON = ' \u27A1\uFE0F'; // Black rightwards arrow (Used as a simple share icon)
const HEART_ICON = ' \u2764\uFE0F'; // Black heart emoji
const EMAIL_ICON = ' \u2709\uFE0F'; // Envelope (Email) emoji
const SCORE_ICON = ' \u23F7'; // Stopwatch (Used for score/speedometer)
const PHONE_ICON = ' \u260E\uFE0F'; // Black telephone receiver
              ...
              <View style={styles.fullScreen}>
                ...
                <View style={styles.buttoncls}>
                  <TouchableOpacity
                    ...
                    {/* Replaced Ant icon with Unicode emoji */}
                    <Text style={[styles.iconStyle, {fontSize: 24, color: '#ccc'}]}>{BACK_ICON}</Text> 
                  </TouchableOpacity>
                </View>
                <View style={styles.buttonheart}>
                  <TouchableOpacity
                    ...
                    {/* Replaced Like icon with Unicode emoji */}
                    <Text
                      style={[
                        styles.iconStyle,
                        {
                          fontSize: 30,
                          color: isLiked[videoId] ? 'red' : '#ffffff',
                        },
                      ]}>
                      {HEART_ICON}
                    </Text>
                ...
                <View style={styles.buttonshare}>
                  <TouchableOpacity onPress={shareOption}>
                    {/* Replaced Shares icon with Unicode emoji */}
                    <Text style={[styles.iconStyle, {fontSize: 30, color: '#ffffff'}]}>{SHARE_ICON}</Text>
                  </TouchableOpacity>
                </View>
                  ...
                  <>
                    <View style={styles.buttonmsg}>
                      <TouchableOpacity onPress={() => sendEmail(item)}>
                        {/* Replaced Whatsapp/Entypo email icon with Unicode emoji */}
                        <Text style={[styles.iconStyle, {fontSize: 27, color: '#ffffff'}]}>{EMAIL_ICON}</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={styles.buttonscore}>
                      <TouchableOpacity
                        ...
                        {/* Replaced Score/MaterialCommunityIcons speedometer icon with Unicode emoji */}
                        <Text style={[styles.iconStyle, {fontSize: 30, color: '#ffffff'}]}>{SCORE_ICON}</Text>
                    ...
                    <View style={styles.buttonphone}>
                      <TouchableOpacity onPress={() => makeCall(item)}>
                        {/* Replaced Phone/FontAwesome6 icon with Unicode emoji */}
                        <Text style={[styles.iconStyle, {fontSize: 22, color: '#ffffff'}]}>{PHONE_ICON}</Text>
                      </TouchableOpacity>
                    </View>
                  </>
                )}
...
const styles = StyleSheet.create({
  ...
  // New style to unify emoji/icon styling properties (size and color are set inline)
  iconStyle: {
    fontWeight: '900', // Making emojis slightly bolder/larger might improve visibility
  },
  buttonscore: {
    position: 'absolute',
    top: '54%',
    right: 27,
    // color: '#ffffff', // Removed as color is set inline or on the Text component
    fontSize: 30, // Removed as size is set inline
    zIndex: 10,
    elevation: 10,
    padding: 10,
  },
  ...
  buttonheart: {
    ...
    top: '60%',
    right: 32,
    // color: '#ffffff', // Removed as color is set inline
    fontSize: 30, // Removed as size is set inline
    zIndex: 10,
    elevation: 10,
    padding: 10,
  ...
  buttonphone: {
    ...
    right: 30,
    // color: '#ffffff', // Removed as color is set inline
    fontSize: 22, // Removed as size is set inline
    zIndex: 10,
    padding: 10,
    elevation: 10,
  },
